...
public class ExcelReadTest {
    ...
    public void testConfDistributeSingleVolumeExcel() {
        // 读取的excel文件路径
        String fileName = "file/全国人单值调整.xlsx";
        // 读取指定sheet页名称
...
//                    volume.setValleyValue(new BigDecimal(data.get(2)));
//                    volume.setPassValue(new BigDecimal(data.get(3)));
//                    volume.setPeakValue(new BigDecimal(data.get(4)));
